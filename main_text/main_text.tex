...
\begin{document}
	...
	of order $\sim10$, \cite{Schmidt2015}).
	...
	\textDelta\emph{xapAB}, and wt. The left panel of
	...
	\begin{figure}%[h!]
		...
		different extracellular concentrations of xanthosine.
		The left panel shows the wild type circuit while
	in the middle the genes \emph{xapABR} and on the right the genes
		...
		in that no subtraction of autofluorescence was carried out,
	...
	Can we gain further insight into how XapR regulates
	the \emph{xapAB} promoter? As mentioned in
	...
	picture is surprisingly and unreasonably effective. In other words,
	...
	We thank Patrick Lenggenhager for his help with \emph{Mathematica} issues, Jane Kondev and Jin Wang for interesting discussions, and Nigel Orme for assistance with illustrations. \textcolor{red}{Portions of the experiments reported here were carried out at the
