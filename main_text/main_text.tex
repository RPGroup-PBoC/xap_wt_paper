...
\begin{document}
	...
	Fig~\subref{fig1:data}{A}, middle panel).
	...
	Fig~\subref{fig1:data}{A}, right panel). Instead, the distribution remains
	...
	\emph{xapAB} promoter: one partially overlapping the polymerase -35 site
	...
	in other measurements covering a smaller dynamic range).
	...
	\begin{figure}%[h!]
		...
		\caption{{\bf Distributions from stochastic simulations and the corresponding deterministic phase portraits.}
			Apart from $\n{[c]_a}$, the parameters are the same as in
			Table~\ref{table1:nondim}. The phase portraits were obtained from the deterministic system similarly to those presented in the previous sections. For the distributions, the simulations
	...
	\begin{figure}%[h!]
		...
		\caption{{\bf Bifurcation diagram showing the hysteresis loop in the stochastic system.}
			...
			bimodal distributions themselves are shown on the right. The arrows illustrate the
	...
	removed and were constructed similarly to those used in~\cite{RazoMejia2018, Belliveau2019}. 
	The $\Delta{xapABR}$ knockout was generated using the approach of
	...
	plasmid pZS25~\cite{Lutz1997},
	containing kanamycin resistance, and integrated at
	the {\it galK} locus using $\lambda$ Red recombineering~\cite{Sharan2009}.
	A xapR-mCherry fusion was constructed in a pZS31 plasmid and was integrated
	into the \textit{ybcN} locus, also using $\lambda$ Red recombineering.
	Expression of the xapR-mCherry fusion was regulated by TetR expressed
	extrachromosomally from a pZS3-PN25 plasmid.
	Expression of the xapR-mCherry fusion was induced by the addition of
	10~ng/mL anhydro-tetracycline.
	A similar expression system was used in~\cite{Brewster2014}
	More details can be found in~\nameref{S1_Text}.
	
	\paragraph*{Flow Cytometry Measurements.}
	Experimental measurements in Fig. 2 were obtained
	...
	appropriate concentration of xanthosine.
	Cultures were allowed to grow at $37\unit{^\circ C}$ for six
	to eight hours to an OD$_{600\unit{nm}}$ of $\approx 0.3$. At this point,
	...
	\begin{thebibliography}{10}
		...
		\bibitem{Lutz1997}
		Lutz R, and Bujard, H
		\newblock Independent and Tight Regulation of Transcriptional Units in \textit{Escherichia Coli} Via the {{LacR}}/{{O}}, the {{TetR}}/{{O}} and {{AraC}}/{{I1}}-{{I2}} Regulatory Elements.
		\newblock Nucleic Acids Research, 1997;25(6), 1203--1210.
		\newblock doi:{10.1093/nar/25.6.1203}
