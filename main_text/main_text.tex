...
\begin{document}
	...
	\begin{figure}%[h!]
		...
		\caption{{\bf Distributions from stochastic simulations and the corresponding deterministic phase portraits.}
			...
			Table~\ref{table1:nondim}. The phase portraits were obtained from the deterministic system as those presented in the previous sections. For the distributions, the simulations
