...
\begin{document}
	...
	\begin{itemize}
		\item In the initial absense of XapB, small amounts of xanthosine permeate\todo{``permeate'' wouldn't include active transport (NupC \& NupG), would it? MM: I think it's sufficiently vague to capture all this, details are too subtle to worry about here} into and out of the cell (discussed in more detail below).
	...
	\todo{MM: do these paragraphs on xanthosine dynamics have an appropriate level of detail now, or too much, or not enough?}
